...
const GoogleSignIn = ({ text = 'Continue with Google', variant = 'default' }) => {
  ...
  const baseClasses = 'w-full flex items-center justify-center space-x-3 px-4 py-3 rounded-lg font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed';
